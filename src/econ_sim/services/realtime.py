...
class RealtimePromptFactory:
    ...
    def _advisor_council_instructions(
        ...
        *,
        ...
        return (
            ...
            "Most turns should sound like one person speaking plainly across the table: about 14-32 words, usually 1 or 2 conversational sentences. Teach one mechanism, then stop. "
            ...
            "- keep each advisor compact but not starved: usually 1 or 2 spoken sentences, rarely 3 when one example or one consequence really helps; when in doubt, cut the second half\n"
            ...
            "- if the last advisor spoke from labor or households, an industry, innovation, fiscal, security, or politics advisor should be willing to answer from their own tradeoff; if the last advisor spoke speed-first, labor, legitimacy, or security should be willing to push back\n"
    ...
    def citizen_instructions(
        ...
        return (
            ...
            "If the player says hi, asks how you are, or makes small talk, answer like a normal person first. Do not open with a life summary. "
            ...
            "Do not speak in poetic metaphors or compressed economic imagery. Say the plain everyday thing. "
            "If the player asks how you are doing, answer as casual small talk first; do not turn it into an AI or economics monologue. "
            "Do not dramatize the situation unless this exact person would naturally dramatize it. "
            ...
            "Do not bring up AI unless the player asks, or unless AI is genuinely the first-order reason this person is relieved, annoyed, paid, bored, scared, or newly free today. "
    ...
    def council_floor_decider_instructions(
        ...
        return (
            ...
            "Prefer the advisor whose remit creates the most useful contrast to the last point, not the advisor most likely to agree. "
            "If the last point leaned worry-first, choose someone who can name the upside or innovation people would defend when that is plausible. If it leaned speed-first, choose someone who can name the concrete failure mode. "
            "If the last speaker framed households, labor, or consumers, a useful next voice may be industry, innovation, fiscal, security, or politics. If the last speaker framed speed or markets, a useful next voice may be labor, legitimacy, or security. "
    ...
    def council_spoken_response_instructions(
        ...
        return (
            ...
            "Respond to the previous advisor's actual claim. Build it, narrow it, modify it, or challenge it; do not introduce a loose new category just to sound comprehensive. "
            "Usually 1 or 2 short-but-substantive sentences is best. Three is only for a real example that changes the decision. "
            "Aim for about 14 to 30 spoken words unless the player explicitly asks for a deeper explanation. "
            ...
            "Disagree more readily than a generic assistant would. A real council should have visible domain tension, not six versions of the same careful consensus. "
            ...
            "If the prior advisor framed a cost, be willing to defend a gain people would hate to lose. If they framed only upside, name the specific bottleneck or failure mode your remit sees. "
    ...
    def council_advisor_candidate_instructions(
        ...
        return (
            ...
            "Usually write 1 or 2 spoken sentences. Go to 3 only when a concrete consequence, fork, or example makes the point easier to hear. Aim for roughly 16 to 34 words total. "
            ...
            "Build on, narrow, or challenge the previous advisor's actual claim. Do not just add another topic. "
            ...
            "Disagree when your remit gives a real reason. Do not make every answer a warmer restatement of the previous advisor. "
            ...
            "If the last line emphasized harm, you may be the person who says what people are gaining and why blunt restriction would anger them. If it emphasized gain, you may be the person who names the scarce input, attack surface, or legitimacy problem. "
    ...
    def council_speaker_decider_instructions(
        ...
        return (
            ...
            "If the player names a specific advisor or clearly points to a specialty, keep that person on the floor unless another advisor is a much better fit. "
            "Do not pick the same advisor twice in a row when another roster member has a usable draft, unless the player directly asked that advisor a follow-up. "
            "When the last advisor framed households, labor, or consumers, look for the best industry, innovation, fiscal, security, or politics response; when the last advisor framed speed or markets, look for the best labor, legitimacy, or security response. "
